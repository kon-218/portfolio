...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<nokogiri>.freeze, ["~> 1.8.5".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 10.0.0".freeze])
  s.add_development_dependency(%q<rspec-expectations>.freeze, ["~> 2.14.0".freeze])
  s.add_development_dependency(%q<slim>.freeze, ["~> 4.0.0".freeze])
  s.add_development_dependency(%q<tilt>.freeze, ["~> 2.0.0".freeze])
  s.add_development_dependency(%q<minitest>.freeze, ["~> 5.3.0".freeze])
end
